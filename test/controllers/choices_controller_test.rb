...
class ChoicesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create choice" do
    assert_difference('Choice.count') do
      post choices_url, params: { choice: { comment: @choice.comment, correct: @choice.correct, dummya: @choice.dummya, dummyb: @choice.dummyb, dummyc: @choice.dummyc, hint: @choice.hint, question_id: @choice.question_id, text: @choice.text } }
    end
  ...
  test "should update choice" do
    patch choice_url(@choice), params: { choice: { comment: @choice.comment, correct: @choice.correct, dummya: @choice.dummya, dummyb: @choice.dummyb, dummyc: @choice.dummyc, hint: @choice.hint, question_id: @choice.question_id, text: @choice.text } }
